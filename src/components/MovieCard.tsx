    ...
    return (
        <section className="group relative mb-2 z-10 hover:z-50
            ...
            <div className="flex flex-col items-start gap-2 absolute left-0 right-0 top-[calc(100%-6rem)]
                ...
                <p className="font-semibold text-lg ">{movie.title ? movie.title : 'No title'}</p>
                ...
                group-hover:max-h-40 group-hover:opacity-100 text-left">{movie.overview ? movie.overview : 'No description available'}</p>
            </div>
            <div className="h-24" />
